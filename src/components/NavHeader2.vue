      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right" role="tablist">
            <li><a href="javascript:;" @click="goHome">首页</a></li>
            <!--<li><a href="javascript:;" @click="goHome">关于我</a></li>-->
            <!--<li><a href="javascript:;" @click="goHome">项目</a></li>-->
            <li>
              <router-link to="/blogs">博客</router-link>
            </li>
            <li>
              <router-link to="/bbs">聊天室</router-link>
            </li>
    ...
    methods: {
      ...
      checkLogin() {
        axios.get("/users/checkLogin").then((response) => {
          ...
          this.$emit('userItem', ...[this.isLogin, this.userName, this.userImg])
      ...
      getHeaderNav() {
        if (this.isFlag) {
          $('.navHeader').css({"position": "absolute", "top": 0})
        }
        let that = this;
        $(window).scroll(function () {
          if (that.isFlag) {
            ...
            if ($(document).scrollTop() >= 100) {
              ...
              $('.navHeader').css({"position": "absolute", "top": 100})
            }
          }
